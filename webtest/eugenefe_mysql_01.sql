...
ALTER TABLE HIFIVE_STRIKE
	ADD FOREIGN KEY (PROD_ID)
	REFERENCES HIFIVE (PROD_ID)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
;


ALTER TABLE HIFIVE_SWAP_IR
	ADD FOREIGN KEY (PROD_ID)
	REFERENCES HIFIVE (PROD_ID)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
...
ALTER TABLE PRICING_UNDERLYING
	ADD FOREIGN KEY (REF_IRC_ID)
	REFERENCES IR_CURVE (IRC_ID)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
...
ALTER TABLE PRICING_UNDERLYING
	...
	REFERENCES PRICING (PRICING_OBJECT, PROD_ID)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
;
...
ALTER TABLE PRICING
	...
	REFERENCES PRICING_METHOD (PRICING_OBJECT)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
;
...
ALTER TABLE PRICING
	...
	REFERENCES VOL_CURVE (VOL_CURVE_ID)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
;
