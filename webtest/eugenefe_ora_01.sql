...
DROP TABLE TAKION79.INTERATE_RATE_HIS;
...
DROP TABLE TAKION79.INTEREST_RATE;
...
CREATE TABLE TAKION79.INTERATE_RATE_HIS
(
	BSSD VARCHAR2(8) NOT NULL,
...
CREATE TABLE TAKION79.INTEREST_RATE
(
	IR_ID VARCHAR2(20) NOT NULL,
	IR_NAME VARCHAR2(50),
	ISSUE_DATE VARCHAR2(8),
...
ALTER TABLE TAKION79.BOND_HIS
	ADD FOREIGN KEY (BSSD)
	REFERENCES TAKION79.BASEDATE (BSSD)
;


ALTER TABLE TAKION79.BOND_INDEX_HIS
	ADD FOREIGN KEY (BSSD)
	REFERENCES TAKION79.BASEDATE (BSSD)
;


ALTER TABLE TAKION79.ETF_HIS
	ADD FOREIGN KEY (BSSD)
	REFERENCES TAKION79.BASEDATE (BSSD)
;


ALTER TABLE TAKION79.ETF_PDF
	ADD FOREIGN KEY (BSSD)
	REFERENCES TAKION79.BASEDATE (BSSD)
;


ALTER TABLE TAKION79.FUTURES_HIS
	ADD FOREIGN KEY (BSSD)
	REFERENCES TAKION79.BASEDATE (BSSD)
;


ALTER TABLE TAKION79.FX_RATE_HIS
	ADD FOREIGN KEY (BSSD)
	REFERENCES TAKION79.BASEDATE (BSSD)
;


ALTER TABLE TAKION79.INTERATE_RATE_HIS
	ADD FOREIGN KEY (BSSD)
	REFERENCES TAKION79.BASEDATE (BSSD)
;


ALTER TABLE TAKION79.IR_CURVE_HIS
	ADD FOREIGN KEY (BSSD)
	REFERENCES TAKION79.BASEDATE (BSSD)
;


ALTER TABLE TAKION79.MACRO_INDEX_HIS
	ADD FOREIGN KEY (BSSD)
	REFERENCES TAKION79.BASEDATE (BSSD)
;


ALTER TABLE TAKION79.OPTION_HIS
	ADD FOREIGN KEY (BSSD)
	REFERENCES TAKION79.BASEDATE (BSSD)
;


ALTER TABLE TAKION79.PORTFOLIO_CASHFLOW
	ADD FOREIGN KEY (BSSD)
	REFERENCES TAKION79.BASEDATE (BSSD)
;
...
ALTER TABLE TAKION79.PORTFOLIO_DETAIL
	ADD FOREIGN KEY (BSSD)
	REFERENCES TAKION79.BASEDATE (BSSD)
;


ALTER TABLE TAKION79.PORTFOLIO_RETURN
	ADD FOREIGN KEY (BSSD)
	REFERENCES TAKION79.BASEDATE (BSSD)
;


ALTER TABLE TAKION79.PORTFOLIO_RISK
	ADD FOREIGN KEY (BSSD)
	REFERENCES TAKION79.BASEDATE (BSSD)
;


ALTER TABLE TAKION79.PORTFOLIO_RISK_DETAIL
	ADD FOREIGN KEY (BSSD)
	REFERENCES TAKION79.BASEDATE (BSSD)
;


ALTER TABLE TAKION79.PORTFOLIO_SENSITIVITY
	ADD FOREIGN KEY (BSSD)
	REFERENCES TAKION79.BASEDATE (BSSD)
;


ALTER TABLE TAKION79.POSITION_CASHFLOW
	ADD FOREIGN KEY (CF_DATE)
	REFERENCES TAKION79.BASEDATE (BSSD)
;
...
ALTER TABLE TAKION79.POSITION_GREEKS
	ADD FOREIGN KEY (BSSD)
	REFERENCES TAKION79.BASEDATE (BSSD)
;


ALTER TABLE TAKION79.POSITION_IR_SENSITITIVY
	ADD FOREIGN KEY (BSSD)
	REFERENCES TAKION79.BASEDATE (BSSD)
;


ALTER TABLE TAKION79.POSITION_RETURN
	ADD FOREIGN KEY (BSSD)
	REFERENCES TAKION79.BASEDATE (BSSD)
;


ALTER TABLE TAKION79.POSITION_RISK
	ADD FOREIGN KEY (BSSD)
	REFERENCES TAKION79.BASEDATE (BSSD)
;


ALTER TABLE TAKION79.PRODUCT_CASHFLOW
	ADD FOREIGN KEY (BSSD)
	REFERENCES TAKION79.BASEDATE (BSSD)
;
...
ALTER TABLE TAKION79.SCENARIO_HIS
	ADD FOREIGN KEY (BSSD)
	REFERENCES TAKION79.BASEDATE (BSSD)
;


ALTER TABLE TAKION79.STOCK_HIS
	ADD FOREIGN KEY (BSSD)
	REFERENCES TAKION79.BASEDATE (BSSD)
;


ALTER TABLE TAKION79.STOCK_INDEX_HIS
	ADD FOREIGN KEY (BSSD)
	REFERENCES TAKION79.BASEDATE (BSSD)
;


ALTER TABLE TAKION79.SYNTHETICS_HIS
	ADD FOREIGN KEY (BSSD)
	REFERENCES TAKION79.BASEDATE (BSSD)
;


ALTER TABLE TAKION79.VCV_MATRIX_HIS
	ADD FOREIGN KEY (BSSD)
	REFERENCES TAKION79.BASEDATE (BSSD)
;


ALTER TABLE TAKION79.BIZUNIT
	ADD FOREIGN KEY (PARENT_ORG_ID)
	REFERENCES TAKION79.BIZUNIT (ORG_ID)
;


ALTER TABLE TAKION79.EMPLOYEE
...
ALTER TABLE TAKION79.BOND_HIS
	...
	REFERENCES TAKION79.BOND (BOND_ID)
;


ALTER TABLE TAKION79.BOND_INDEX_DETAIL
	ADD FOREIGN KEY (BOND_ID)
	REFERENCES TAKION79.BOND (BOND_ID)
;
...
ALTER TABLE TAKION79.BOND_INDEX_DETAIL
	...
	REFERENCES TAKION79.BOND_INDEX (BOND_INDEX_ID)
;
...
ALTER TABLE TAKION79.HIFIVE
	ADD FOREIGN KEY (COUNTERPARTY_ID)
	REFERENCES TAKION79.COUNTERPARTY (COUNTERPARTY_ID)
;


ALTER TABLE TAKION79.POSITION
...
ALTER TABLE TAKION79.POSITION
	...
	REFERENCES TAKION79.EMPLOYEE (MEMBER_ID)
;


ALTER TABLE TAKION79.ETF_HIS
	ADD FOREIGN KEY (ETF_ID)
	REFERENCES TAKION79.ETF (ETF_ID)
;
...
ALTER TABLE TAKION79.POSITION
	...
	REFERENCES TAKION79.FN_ACCOUNT (ACCOUNT_ID)
;


ALTER TABLE TAKION79.FUTURES_HIS
	ADD FOREIGN KEY (FUTURES_ID)
	REFERENCES TAKION79.FUTURES (FUTURES_ID)
;


ALTER TABLE TAKION79.FX_RATE_HIS
	ADD FOREIGN KEY (FX_ID)
	REFERENCES TAKION79.FX_CASH (FX_ID)
;


ALTER TABLE TAKION79.HIFIVE_STRIKE
	ADD FOREIGN KEY (PROD_ID)
	REFERENCES TAKION79.HIFIVE (PROD_ID)
;


ALTER TABLE TAKION79.HIFIVE_SWAP_IR
	ADD FOREIGN KEY (PROD_ID)
	REFERENCES TAKION79.HIFIVE (PROD_ID)
;


ALTER TABLE TAKION79.HIFIVE_UNDERLYING
	ADD FOREIGN KEY (PROD_ID)
	REFERENCES TAKION79.HIFIVE (PROD_ID)
;


ALTER TABLE TAKION79.PRICING
	ADD FOREIGN KEY (PROD_ID)
	REFERENCES TAKION79.HIFIVE (PROD_ID)
;
...
ALTER TABLE TAKION79.INTERATE_RATE_HIS
	...
	REFERENCES TAKION79.INTEREST_RATE (IR_ID)
;


ALTER TABLE TAKION79.IRC_BUCKET_DETAIL
	ADD FOREIGN KEY (IR_ID)
	REFERENCES TAKION79.INTEREST_RATE (IR_ID)
;
...
ALTER TABLE TAKION79.HIFIVE_SWAP_IR
	...
	REFERENCES TAKION79.IR_CURVE (IRC_ID)
;
...
ALTER TABLE TAKION79.IRC_FUNCTION_DETAIL
	ADD FOREIGN KEY (IRC_ID)
	REFERENCES TAKION79.IR_CURVE (IRC_ID)
;
...
ALTER TABLE TAKION79.PRICING_UNDERLYING
	ADD FOREIGN KEY (REF_IRC_ID)
	REFERENCES TAKION79.IR_CURVE (IRC_ID)
;
...
ALTER TABLE TAKION79.MACRO_INDEX_HIS
	...
	REFERENCES TAKION79.MACRO_INDEX (MACRO_INDEX_ID)
;


ALTER TABLE TAKION79.BOND
	ADD FOREIGN KEY (BOND_ID)
	REFERENCES TAKION79.MARKET_VARIABLE (MV_ID)
;


ALTER TABLE TAKION79.BOND_INDEX
	ADD FOREIGN KEY (BOND_INDEX_ID)
	REFERENCES TAKION79.MARKET_VARIABLE (MV_ID)
;


ALTER TABLE TAKION79.ETF
	ADD FOREIGN KEY (ETF_ID)
	REFERENCES TAKION79.MARKET_VARIABLE (MV_ID)
;
...
ALTER TABLE TAKION79.FX_CASH
	ADD FOREIGN KEY (FX_ID)
	REFERENCES TAKION79.MARKET_VARIABLE (MV_ID)
;


ALTER TABLE TAKION79.INTEREST_RATE
	ADD FOREIGN KEY (IR_ID)
	REFERENCES TAKION79.MARKET_VARIABLE (MV_ID)
;


ALTER TABLE TAKION79.MACRO_INDEX
	ADD FOREIGN KEY (MACRO_INDEX_ID)
	REFERENCES TAKION79.MARKET_VARIABLE (MV_ID)
;


ALTER TABLE TAKION79.OPTIONS
	ADD FOREIGN KEY (UNDERLYING_ID)
	REFERENCES TAKION79.MARKET_VARIABLE (MV_ID)
;
...
ALTER TABLE TAKION79.RISK_FACTOR
	ADD FOREIGN KEY (RF_ID)
	REFERENCES TAKION79.MARKET_VARIABLE (MV_ID)
;


ALTER TABLE TAKION79.SCENARIO_DETAIL
	ADD FOREIGN KEY (MV_ID)
	REFERENCES TAKION79.MARKET_VARIABLE (MV_ID)
;


ALTER TABLE TAKION79.STOCK
	ADD FOREIGN KEY (STOCK_ID)
	REFERENCES TAKION79.MARKET_VARIABLE (MV_ID)
;


ALTER TABLE TAKION79.STOCK_INDEX
	ADD FOREIGN KEY (ST_INDEX_ID)
	REFERENCES TAKION79.MARKET_VARIABLE (MV_ID)
;


ALTER TABLE TAKION79.SYNTHETICS
	ADD FOREIGN KEY (SYN_PROD_ID)
	REFERENCES TAKION79.MARKET_VARIABLE (MV_ID)
;


ALTER TABLE TAKION79.SYNTHETIC_DETAIL
...
ALTER TABLE TAKION79.HIFIVE_SWAP_IR
	ADD FOREIGN KEY (PAYMENT_TERM)
	REFERENCES TAKION79.MATURITY (MATURITY_ID)
;
...
ALTER TABLE TAKION79.OPTION_HIS
	ADD FOREIGN KEY (OPTION_ID)
	REFERENCES TAKION79.OPTIONS (OPTION_ID)
;


ALTER TABLE TAKION79.PORTFOLIO
	ADD FOREIGN KEY (PARENT_PORT_ID)
	REFERENCES TAKION79.PORTFOLIO (PORT_ID)
;
...
ALTER TABLE TAKION79.PORTFOLIO_CHILD
	ADD FOREIGN KEY (SUB_PORT_ID)
	REFERENCES TAKION79.PORTFOLIO (PORT_ID)
;
...
ALTER TABLE TAKION79.PORTFOLIO_DETAIL
	...
	REFERENCES TAKION79.POSITION (POS_ID)
;
...
ALTER TABLE TAKION79.POSITION_RISK_DETAIL
	ADD FOREIGN KEY (BSSD, POS_ID, VAR_GEN_ID)
	REFERENCES TAKION79.POSITION_RISK (BSSD, POS_ID, VAR_GEN_ID)
;


ALTER TABLE TAKION79.PRICING
	ADD FOREIGN KEY (PRICER_ID)
	REFERENCES TAKION79.PRICER (PRICER_ID)
;


ALTER TABLE TAKION79.PRICING_UNDERLYING
	ADD FOREIGN KEY (PRICING_OBJECT, PROD_ID)
	REFERENCES TAKION79.PRICING (PRICING_OBJECT, PROD_ID)
;


ALTER TABLE TAKION79.PRICING
	ADD FOREIGN KEY (PRICING_OBJECT)
	REFERENCES TAKION79.PRICING_METHOD (PRICING_OBJECT)
;


ALTER TABLE TAKION79.PORTFOLIO_RISK_DETAIL
	ADD FOREIGN KEY (RF_ID)
	REFERENCES TAKION79.RISK_FACTOR (RF_ID)
;
...
ALTER TABLE TAKION79.SCENARIO_DETAIL
	...
	REFERENCES TAKION79.SCENARIO (SCENARIO_ID)
;


ALTER TABLE TAKION79.SCENARIO_HIS
	ADD FOREIGN KEY (SCENARIO_ID, MV_ID)
	REFERENCES TAKION79.SCENARIO_DETAIL (SCENARIO_ID, MV_ID)
;


ALTER TABLE TAKION79.SCENARIO
	ADD FOREIGN KEY (SCENARIO_SET)
	REFERENCES TAKION79.SCENARIO_SET (SCENARIO_SET)
;


ALTER TABLE TAKION79.SCENARIO_SET
	ADD FOREIGN KEY (VAR_SCE_ID)
	REFERENCES TAKION79.SCENARIO_VAR (VAR_SCE_ID)
;


ALTER TABLE TAKION79.HIFIVE_UNDERLYING
	ADD FOREIGN KEY (STOCK_ID)
	REFERENCES TAKION79.STOCK (STOCK_ID)
;
...
ALTER TABLE TAKION79.STOCK_INDEX_DETAIL
	ADD FOREIGN KEY (STOCK_ID)
	REFERENCES TAKION79.STOCK (STOCK_ID)
;
...
ALTER TABLE TAKION79.ETF
	...
	REFERENCES TAKION79.STOCK_INDEX (ST_INDEX_ID)
;
...
ALTER TABLE TAKION79.SYNTHETICS_HIS
	ADD FOREIGN KEY (SYN_PROD_ID)
	REFERENCES TAKION79.SYNTHETICS (SYN_PROD_ID)
;
...
ALTER TABLE TAKION79.PORTFOLIO_RISK
	...
	REFERENCES TAKION79.VAR_GEN_MCD (VAR_GEN_ID)
;
...
ALTER TABLE TAKION79.PRICING
	...
	REFERENCES TAKION79.VCV_MATRIX (VCV_ID)
;


ALTER TABLE TAKION79.SCENARIO_VAR
	ADD FOREIGN KEY (VCV_ID)
	REFERENCES TAKION79.VCV_MATRIX (VCV_ID)
;
...
ALTER TABLE TAKION79.PRICING
	ADD FOREIGN KEY (VOL_CURVE_ID)
	REFERENCES TAKION79.VOL_CURVE (VOL_CURVE_ID)
;
